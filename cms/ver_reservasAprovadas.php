        ...
        <div id="esqueleto">
            ...
            <section>
                ...
                <div id="div_foraTabela">
                    <div id="div_conteudo">
                        <!--Título da Tabela-->
                        <div id="div_tituloTabela2">
                            Reservas Aprovadas
                        </div>
                        <!--Tabela Aprovados-->
                        <div id="tabela_crud_titulos2">
                            ...
                            <div class="titulo_1opcColuna">
                                Opções
                            </div>
                        </div>
                        <div id="tabela_crud_conteudo2">
                            <?php
                                //Comando SQL
                                ...
                                inner join tbl_cliente as c on c.id_cliente = rs.id_cliente where rs.id_status = 1";
                            ...
                            <div class="coluna_1opcao">
                                <!--Informações-->
                                <a href="ver_reservasAprovadas.php?id=<?php echo($idReserva); ?>&modo=verInfo">
