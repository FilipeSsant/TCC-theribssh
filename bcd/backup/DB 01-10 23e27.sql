...
INSERT INTO `tbl_cidade` VALUES (1,1,'Jandira'),(2,1,'Barueri'),(3,1,'Osasco');
...
INSERT INTO `tbl_cliente` VALUES (1,1,'jailson4524','ja','Jailson Mendes','Laranjal','(11) 23213-2131','(12) 3123-1230','jailson.mendes@gmail.com','arquivos/foto_usuario/mickeyilson.png'),(2,2,'master_race','filipe','Filipe da Silva','Santos','(11) 85198-1156','(11) 9848-9489','filipe@gmail.com','arquivos/foto_usuario/20170125-006.jpg');
...
INSERT INTO `tbl_endereco` VALUES (1,1,'','Jardim das Peças','Rua das Laranjas','-','61'),(2,1,'Rua Ancião Sebastião Antonini','Jardim das Margaridas','Rua Ancião Sebastião Antonini','31-27','61');
...
CREATE TABLE `tbl_feedback` (
  ...
  KEY `fk_id_cliente4_idx` (`id_cliente`),
  KEY `fk_id_funcionario2_idx` (`id_funcionario`),
  ...
  CONSTRAINT `fk_id_cliente4` FOREIGN KEY (`id_cliente`) REFERENCES `tbl_cliente` (`id_cliente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_id_funcionario2` FOREIGN KEY (`id_funcionario`) REFERENCES `tbl_funcionario` (`id_funcionario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_funcionario` (
  ...
  UNIQUE KEY `login_UNIQUE` (`login`),
  UNIQUE KEY `dia_pagamento_UNIQUE` (`dia_pagamento`),
  KEY `fk_id_restaurante_idx` (`id_restaurante`),
  KEY `fk_id_endereco_idx` (`id_endereco`),
  KEY `fk_id_cargo_idx` (`id_cargo`),
...
INSERT INTO `tbl_home` VALUES (2,'arquivos/midia_home/reserva1.jpg','arquivos/midia_home/teste4.jpg',1);
...
INSERT INTO `tbl_paletacor` VALUES (56,'Azul Ciano','#027d7a','#ffffff','#00bfac','#00b1bf',1),(57,'Cor fracassada','#000000','#000000','#000000','#000000',0);
...
INSERT INTO `tbl_redesocial` VALUES (1,'Facebook','arquivos/imagem_redesSociais/facebook.png','http://www.facebook.com');
...
INSERT INTO `tbl_sobrenos` VALUES (1,'Artigo 1','O restaurante tem como objetivo atender ao público com gostos diversos, temos vários tipos de pratos desde o prato destinado aos apreciantes da arte do churrasco, quanto aos tem uma preferência à saladas.','',1);
...
INSERT INTO `tbl_tipoinfo` VALUES (1,'Reclamação');
...
-- Dump completed on 2017-10-01 23:57:52
