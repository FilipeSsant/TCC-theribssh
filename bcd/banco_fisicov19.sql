...
--
-- Create schema dbtheribssh
--

CREATE DATABASE IF NOT EXISTS dbtheribssh;
USE dbtheribssh;

--
-- Definition of table `tbl_avaliacao`
--
...
INSERT INTO `tbl_banco` (`id_banco`,`nome`,`logo`) VALUES 
 (1,'Mastercard','caminho'),
 (2,'Visa','caminho');
/*!40000 ALTER TABLE `tbl_banco` ENABLE KEYS */;


--
-- Definition of table `tbl_boleto`
--
...
--
-- Definition of table `tbl_cardapio`
--
...
INSERT INTO `tbl_cardapio` (`id_cardapio`,`id_restaurante`,`nome`,`status`) VALUES 
 (6,1,'Cardápio Oficial',1);
/*!40000 ALTER TABLE `tbl_cardapio` ENABLE KEYS */;


--
-- Definition of table `tbl_cardapioproduto`
--
...
INSERT INTO `tbl_cardapioproduto` (`id_cardapioProduto`,`id_cardapio`,`id_produto`,`principais`) VALUES 
 (22,6,5,1),
 (23,6,6,0),
 (24,6,7,1);
...
INSERT INTO `tbl_cargo` (`id_cargo`,`nome`) VALUES 
 (20,'Administrador'),
 (21,'Cozinheiro');
...
--
-- Definition of table `tbl_cargopermissao`
--
...
INSERT INTO `tbl_cargopermissao` (`id_cargoPermissao`,`id_cargo`,`id_permissao`) VALUES 
 (89,20,1),
 (90,20,2),
 (91,20,3),
 (92,20,4),
...
--
-- Definition of table `tbl_cartaocredito`
--
...
INSERT INTO `tbl_cartaocredito` (`id_cartaocredito`,`id_cliente`,`id_banco`,`numero`,`nome_cartao`,`data`,`cvv`) VALUES 
 (1,3,1,'6541 6546 5351 6556','BEATRIZ CASTRO','12/2017','123'),
 (2,5,2,'6666 6666 6666 6666','MATHEUS MACHADO FROTA','25/2019','666');
/*!40000 ALTER TABLE `tbl_cartaocredito` ENABLE KEYS */;


--
-- Definition of table `tbl_categoria`
--
...
INSERT INTO `tbl_categoria` (`id_categoria`,`nome`,`imagem`) VALUES 
 (1,'Steakhouse','arquivos/icones_categorias/steak (2).png'),
 (3,'Vegetariano','arquivos/icones_categorias/broccoli.png'),
 (4,'Saúdavel','arquivos/icones_categorias/salad.png');
/*!40000 ALTER TABLE `tbl_categoria` ENABLE KEYS */;


--
-- Definition of table `tbl_cidade`
--
...
INSERT INTO `tbl_cidade` (`id_cidade`,`id_estado`,`nome`) VALUES 
 (1,1,'Jandira'),
 (2,1,'Barueri'),
 (3,1,'Osasco'),
 (4,2,'Niterói'),
...
--
-- Definition of table `tbl_cliente`
--
...
INSERT INTO `tbl_cliente` (`id_cliente`,`id_endereco`,`login`,`senha`,`nome`,`sobrenome`,`celular`,`telefone`,`email`,`foto`) VALUES 
 (1,1,'jailson4524','ja','Jailson Mendes','Laranjal','(11) 23213-2131','(12) 3123-1230','jailson.mendes@gmail.com','arquivos/foto_usuario/mickeyilson.png'),
 (2,2,'filipe','filipe','Filipe da Silva','Santos','(11) 85198-1156','(11) 9848-9489','filipe@gmail.com','arquivos/foto_usuario/sanik.png'),
 (3,3,'bia','sonico','Beatriz','Castro','(11) 97024-1518','(11) 4303-5101','biia@gmail.com','arquivos/foto_usuario/sonicwut.jpg'),
 (4,7,'pablo_azul','pablo','Pablo','Backyardigan','(11) 98045-6878','(11) 4205-4575','pablo@backyardigan.com','arquivos/foto_usuario/inventor_pablo_grimacing_the_backyardigans.png'),
 (5,24,'MatheusFrota25','belinha123teamo','Matheus ','Machado Frota','(11) 98553-8302','(11) 4136-8749','matheus.frota25052000@gmail.com','arquivos/foto_usuario/images.jpg');
/*!40000 ALTER TABLE `tbl_cliente` ENABLE KEYS */;


--
-- Definition of table `tbl_contabancaria`
--
...
INSERT INTO `tbl_contabancaria` (`id_contabancaria`,`id_funcionario`,`id_banco`,`agencia`,`conta_corrente`) VALUES 
 (6,21,1,'4165','74849848-9'),
 (7,22,1,'4451','11546515-1');
/*!40000 ALTER TABLE `tbl_contabancaria` ENABLE KEYS */;


--
-- Definition of table `tbl_credito`
--
...
--
-- Definition of table `tbl_endereco`
--
...
INSERT INTO `tbl_endereco` (`id_endereco`,`id_cidade`,`logradouro`,`bairro`,`rua`,`aptbloco`,`numero`) VALUES 
 (1,1,'','Jardim das Peças','Rua das Laranjas','-','61'),
 (2,1,'Rua Ancião Sebastião Antonini','Jardim das Margaridas','Rua Ancião Sebastião Antonini','31-27','61'),
 (3,2,'Bar do Zé','Jd. Silveira','Maria Siqueira','-','102'),
 (5,1,'Próximo ao Centro','Jardim Tupã','Rua Fernando Pessoa','-','32'),
 (6,7,'O mundo inteiro no nosso quintal','Diversão','Casa','-','25'),
 (7,2,'Perto da única casa que tem aqui','Illusion Paradise','Quintal ','-','45'),
 (8,2,'Bar do Away','Sonicolândia','Rua das Argolas Douradas','-','133'),
 (9,2,'32123','jardim','Rua das Flroes','-','213'),
 (24,7,'casa 12','Vila Dirce ','Av. Inocêncio Seráfico ','-','3021'),
 (31,1,'Escola SENAI Jandira','Jardim das Rosas','Antônio Figueredo','-','41'),
 (32,1,'Escola SENAI Jandira','Jardim das Rosas','Antônio Figueredo','-','41'),
 (33,3,'Perto do Bar do Pudim','Jardim dos Confeitos','Rua da Clara de Ovo','-','13'),
 (34,1,'Escola SENAI Jandira','Jardim das Rosas','Rua da Clara de Ovo','-','41'),
 (35,2,'96','amado','francisco','52-7','528'),
 (36,1,'Perto da Loja do seu Zé','Espinafre verde','Pudim Reluzente','-','452');
/*!40000 ALTER TABLE `tbl_endereco` ENABLE KEYS */;


--
-- Definition of table `tbl_enquete`
--
...
INSERT INTO `tbl_enquete` (`id_enquete`,`titulo`,`status`) VALUES 
 (2,'Rendimento dos Garçons',0),
 (3,'Cor do Site',1),
 (4,'a',0);
...
INSERT INTO `tbl_estado` (`id_estado`,`id_regiao`,`nome`) VALUES 
 (1,9,'São Paulo'),
 (2,9,'Rio de Janeiro');
...
--
-- Definition of table `tbl_faleconosco`
--
...
INSERT INTO `tbl_faleconosco` (`id_faleconosco`,`id_tipoInfo`,`id_restaurante`,`nome_completo`,`celular`,`telefone`,`email`,`obs`) VALUES 
 (3,1,1,'Jailson Mendes','(11) 54564-5616','(11) 9848-9489','jaja@gmail.com','Muda a cor do site.'),
 (4,1,1,'José Mariano','(11) 98045-6165','(11) 4202-0650','jose@gmail.com','A comida precisa de mais sal!');
/*!40000 ALTER TABLE `tbl_faleconosco` ENABLE KEYS */;


--
-- Definition of table `tbl_faq`
--
...
INSERT INTO `tbl_faq` (`id_faq`,`pergunta`,`resposta`) VALUES 
 (5,'Como acessar meu perfil?','Depois de logado, é necessário passar o mouse em cima sua imagem de perfil e assim aparecerá uma pequena janela flutuante.'),
 (6,'Por que não consigo fazer minhas reservas?','A reserva só pode ser feita após 24 horas da criação da conta.');
...
--
-- Definition of table `tbl_fornecedor`
--
...
--
-- Definition of table `tbl_funcionario`
--
...
INSERT INTO `tbl_funcionario` (`id_funcionario`,`id_restaurante`,`id_cargo`,`id_endereco`,`cpf`,`nome_completo`,`num_registro`,`sexo`,`telefone`,`celular`,`salario`,`dt_nasc`,`statusMDM`,`foto`,`email`,`dia_pagamento`,`comissao`,`login`,`senha`) VALUES 
 (21,1,20,34,'894.989.789-48','DEVSOFT CORPORATION','156.156.561','M','(11) 4511-6515','(11) 98465-1651',15000.00,'2000-01-13',0,'arquivos/foto_perfilFuncionario/adasdsadsd.png','dev@devsoft.com','15',0.00,'devsoft','dev'),
 (22,1,21,36,'515.616.516-51','PALMIRINHA ONOFRE','451.651.651','M','(11) 4561-2313','(11) 98054-6515',2500.00,'1931-06-29',1,'arquivos/foto_perfilFuncionario/yuzk9zom.jpeg','palmirinha@ribs.com','12',0.00,'palmirinha','123');
/*!40000 ALTER TABLE `tbl_funcionario` ENABLE KEYS */;


--
-- Definition of table `tbl_home`
--
...
INSERT INTO `tbl_home` (`id_home`,`caminho_imagemSuperior`,`caminho_imagemInferior`,`status`) VALUES 
 (3,'arquivos/midia_home/q-grill-camden-1.jpg','arquivos/midia_home/steak_1472646321611_5895592_ver1.0.jpg',1);
/*!40000 ALTER TABLE `tbl_home` ENABLE KEYS */;


--
-- Definition of table `tbl_ingrediente`
--
...
INSERT INTO `tbl_ingrediente` (`id_ingrediente`,`nome`) VALUES 
 (1,'Tomate'),
 (2,'Alface'),
 (3,'Salsinha'),
 (4,'Cebolinha'),
...
--
-- Definition of table `tbl_ingredienteproduto`
--
...
INSERT INTO `tbl_ingredienteproduto` (`id_ingredienteProduto`,`id_ingrediente`,`id_produto`,`id_tipounit`,`quantidade`,`detalhe`) VALUES 
 (55,5,5,4,400,''),
 (58,16,5,4,400,'a gosto'),
 (59,17,5,4,0.5,'Picada'),
 (60,17,6,6,1,'Ralada'),
 (61,18,6,4,250,'Tipo Penne'),
 (63,23,7,7,1,''),
 (64,22,7,6,2,''),
 (65,21,7,6,1,'');
...
--
-- Definition of table `tbl_materiaprima`
--
...
INSERT INTO `tbl_mesa` (`id_mesa`,`id_restaurante`,`id_tipomesa`,`nome`) VALUES 
 (1,1,1,'A1');
/*!40000 ALTER TABLE `tbl_mesa` ENABLE KEYS */;


--
-- Definition of table `tbl_opcao`
--
...
INSERT INTO `tbl_opcao` (`id_opcao`,`id_pergunta`,`alternativa1`,`alternativa2`,`alternativa3`,`alternativa4`) VALUES 
 (30,1,'Bom','Razoável','Ruim','Péssimo'),
 (31,3,'Sim','Não','','');
...
INSERT INTO `tbl_pais` (`id_pais`,`nome`) VALUES 
 (1,'Brasil');
/*!40000 ALTER TABLE `tbl_pais` ENABLE KEYS */;


--
-- Definition of table `tbl_paletacor`
--
...
INSERT INTO `tbl_paletacor` (`id_paletacor`,`titulo`,`cor_primaria`,`cor_secundaria`,`cor_terciaria`,`cor_quartenaria`,`status`) VALUES 
 (56,'Cor Padrão','#291818','#ffffff','#200b00','#441a1a',1);
/*!40000 ALTER TABLE `tbl_paletacor` ENABLE KEYS */;


--
-- Definition of table `tbl_pedido`
--
...
--
-- Definition of table `tbl_pedidocompra`
--
...
--
-- Definition of table `tbl_pedidoproduto`
--
...
--
-- Definition of table `tbl_pergunta`
--
...
INSERT INTO `tbl_pergunta` (`id_pergunta`,`id_enquete`,`pergunta`) VALUES 
 (1,2,'Qual o desempenho dos nossos garçons?'),
 (3,3,'A cor do site está agradável?');
...
--
-- Definition of table `tbl_periodorestaurante`
--
...
--
-- Definition of table `tbl_permissao`
--
...
INSERT INTO `tbl_permissao` (`id_permissao`,`nome`) VALUES 
 (1,'Fechamento do Pedido'),
 (2,'Aprovacao do Produto'),
 (3,'Crud Paleta de Cores'),
 (4,'Crud Cardápio'),
 (5,'Crud Home'),
 (6,'Crud de Produtos'),
 (7,'Crud Categorias'),
 (8,'Crud Funcionários'),
 (9,'Crud Cargos'),
 (10,'Crud Usuários Cadastrados'),
 (11,'Crud Mesas'),
 (12,'Crud Reservas'),
 (13,'Crud Enquetes'),
 (14,'Crud Sobre Nós'),
 (15,'Crud Fale Conosco'),
 (16,'Crud FAQ'),
 (17,'Crud Redes Sociais');
...
INSERT INTO `tbl_produto` (`id_produto`,`id_categoria`,`descricao`,`nome`,`imagem`,`preco`,`statusAprovacao`,`statusTabelaNuticional`) VALUES 
 (5,1,'E quando o filé mignon ainda é acompanhado por um molho gostoso, você pode ter certeza que estará diante de um prato maravilhoso. Como o molho madeira que irá acompanhar o filé mignon em nossa receita.','Filé Mignon ao Molho Madeira','arquivos/foto_produtos/asdsasasd.png',40.5,1,0),
 (6,3,'Uma mistura de ingredientes que harmonizam, dando um sabor diferenciado e incomum aos paladares.','Salada de Penne','arquivos/foto_produtos/4037_original.jpg',25.5,1,0),
 (7,4,'Um suco feito à base de folhas verdes escuras que carregam em si a clorofila. ','Suco Verde','arquivos/foto_produtos/capturar.png',4,1,0);
/*!40000 ALTER TABLE `tbl_produto` ENABLE KEYS */;


--
-- Definition of table `tbl_redesocial`
--
...
INSERT INTO `tbl_redesocial` (`id_redesocial`,`nome`,`imagem`,`link`,`status`) VALUES 
 (6,'Twitter','arquivos/imagem_redesSociais/qfy0krip_400x400.jpg','http://www.twitter.com',1),
 (7,'Facebook','arquivos/imagem_redesSociais/fa.png','http://www.facebook.com',1),
 (8,'LinkedIn','arquivos/imagem_redesSociais/1200x630bb.jpg','http://www.linkedin.com',1);
/*!40000 ALTER TABLE `tbl_redesocial` ENABLE KEYS */;


--
-- Definition of table `tbl_regiao`
--
...
INSERT INTO `tbl_regiao` (`id_regiao`,`id_pais`,`nome`) VALUES 
 (9,1,'Sudeste'),
 (10,1,'Norte'),
 (11,1,'Nordeste'),
 (12,1,'Centro-Oeste'),
...
--
-- Definition of table `tbl_reserva`
--
...
--
-- Definition of table `tbl_respostaenquete`
--
...
INSERT INTO `tbl_respostaenquete` (`id_respostaEnquete`,`id_enquete`,`alternativa`) VALUES 
 (1,3,'alternativa1'),
 (2,3,'alternativa2'),
 (3,3,'alternativa1'),
 (4,3,'alternativa2'),
...
--
-- Definition of table `tbl_restaurante`
--
...
INSERT INTO `tbl_restaurante` (`id_restaurante`,`nome`,`id_endereco`,`imagem`,`descricao`) VALUES 
 (1,'Restaurante 1',5,'caminho_imagem','a discutir');
/*!40000 ALTER TABLE `tbl_restaurante` ENABLE KEYS */;


--
-- Definition of table `tbl_sobrenos`
--
...
INSERT INTO `tbl_sobrenos` (`id_sobrenos`,`titulo`,`texto`,`caminho_imagem`,`status`) VALUES 
 (1,'Artigo 1','O restaurante tem como objetivo atender ao público com gostos diversos, temos vários tipos de pratos desde o prato destinado aos apreciantes da arte do churrasco, quanto aos tem uma preferência à saladas.','arquivos/midia_sobreNos/reserva1.jpg',1);
...
--
-- Definition of table `tbl_tipoinfo`
--
...
INSERT INTO `tbl_tipoinfo` (`id_tipoInfo`,`nome`) VALUES 
 (1,'Reclamação'),
 (2,'Sugestão'),
 (3,'Informação');
...
--
-- Definition of table `tbl_tipomesa`
--
...
INSERT INTO `tbl_tipomesa` (`id_tipomesa`,`nome`) VALUES 
 (1,'4'),
 (2,'8'),
 (3,'12');
...
--
-- Definition of table `tbl_tipounit`
--
...
INSERT INTO `tbl_tipounit` (`id_tipounit`,`nome`,`sigla`) VALUES 
 (4,'Grama','g'),
 (5,'Kilo','kg'),
 (6,'Unidade',''),
 (7,'Litro','L'),
