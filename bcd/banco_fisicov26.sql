...
INSERT INTO `tbl_cardapioproduto` VALUES (22,6,5,1),(23,6,6,0),(24,6,7,0);
...
INSERT INTO `tbl_cartaocredito` VALUES (1,3,1,'6541 6546 5351 6556','BEATRIZ CASTRO','12/2017','123'),(3,6,2,'5645 4646 5666 4564','4546456764','12/2019','656'),(4,7,2,'6666 6666 6666 6666','NOé','25/2018','666');
...
INSERT INTO `tbl_funcionario` VALUES (21,1,20,34,'894.989.789-48','DEVSOFT CORPORATION','156.156.561','M','(11) 4511-6515','(11) 98465-1651',15000.00,'2000-01-13',0,'arquivos/foto_perfilFuncionario/adasdsadsd.png','dev@devsoft.com','15',0.00,'devsoft','dev'),(22,1,22,36,'515.616.516-51','PALMIRINHA ONOFRE','451.651.651','M','(11) 4561-2313','(11) 98054-6515',2500.00,'1931-06-29',0,'arquivos/foto_perfilfuncionario/yuzk9zom.jpeg','palmirinha@hotmail.com','12',0.12,'palmirinha','123');
...
INSERT INTO `tbl_mesa` VALUES (1,1,1,'A1'),(2,2,2,'A5'),(3,2,1,'A2'),(4,1,2,'A3'),(7,1,2,'A6');
...
CREATE TABLE `tbl_pedido` (
  ...
  CONSTRAINT `fk_id_mesa6` FOREIGN KEY (`id_mesa`) REFERENCES `tbl_mesa` (`id_mesa`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_pedido` VALUES (1,22,1,1,'2017-11-15 13:09:57'),(2,22,2,4,'2017-11-15 15:06:26'),(3,22,3,7,'2017-11-15 17:33:08');
...
INSERT INTO `tbl_pedidoproduto` VALUES (1,1,5),(2,1,6),(3,1,7),(4,2,7),(5,2,5),(6,3,7),(7,3,5);
...
INSERT INTO `tbl_reserva` VALUES (44,2,1,1,1,1,'2017-11-09 15:15:12','2017-11-10');
...
INSERT INTO `tbl_status` VALUES (1,'Preparado'),(2,'Cancelado'),(3,'Em preparação');
...
-- Dump completed on 2017-11-16  0:21:08
