...
﻿<!--Div de Cadastro-->
<div id="div_foraCadastroReserva_mobile" style="background-color:<?php echo($corPrimaria); ?>;">
    <!--Botão fechar-->
	<div class="botao_fecharPopUp" onClick="fecharReserva()" style="background-color:<?php echo($corQuartenaria); ?>;">
		<img src="../img/fecharPopUp.png" alt="">
	</div>
    <!--Div de Login-->
    <div id="div_cadastroReserva_mobile">
        <!--Título div Cadastro-->
        ...
        <div class="formulario_cadastro">
            <form name="formCadastroReserva" method="post" action="#">
                ...
                <input id="input_dia" type="hidden" name="txt_dtMarcada"><br>
                <!--Select Período-->
